...
HD_PWD='C:/Users/Zach/Desktop/ComputerS/year2/semester II/Computer Architecture/MIPS16bits/MIPS16bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mip.tcl -notrace
